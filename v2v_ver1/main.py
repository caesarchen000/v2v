...
def sender_pipeline_part1():
    # detect user's voice
    record_audio.record_audio(filename='sender_tmp/sender.wav', fs=44100, channels=2, max_seconds=300)  # record audio

    # convert voice to text
    wav_to_txt.wav_to_txt(input_path='sender_tmp/sender.wav', output_path='sender_tmp/sender.txt')
